            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Pendaftaran Kegiatan Berhasil!</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Halo {{auth()->user()->name}}</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                               <p>Melalui email ini, Kami ingin mengingatkan Anda untuk mengikuti {{$details->topic}}. Yang Akan diselenggarakan pada.</p>

                                <p>Waktu	        :	{{$details->start_at}}</p>
                                <p>ID Meeting	    :	{{$details->meeting_id}}</p>
                                <p>Password         :   {{$details->password}}</p>
                                <p>Tautan Kegiatan	:   <a href="{{$details->start_url}}">Masuk</a></p>
                            </td>
                          </tr>
                        </table>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Terima Kasih. Kami menghargai waktu dan perhatian Anda untuk mengikuti kegiatan ini.</p>
